 ...
 */  
public class ExtjsFileUtilsBak {
	/** 
     ...
     * @return FileInfo 
     */  
    public static FileInfoBak getFileInfo(File file) {  
    ...
    public static void setFileInfo(File file, FileInfoBak info) {  
     ...
     * @param file 文件目录 
     */  
    public static void getAllFileInfo(FileInfoBak info, File file) {  
        if (file.isDirectory()) {  
            long size = 0;  
            File[] allFiles = file.listFiles();  
            for (File f : allFiles) {  
                size += f.length();  
                FileInfoBak fi = getFileInfo(f);  
     ...
     * @param file 目录 
     */  
    public static void getFileInfo(FileInfoBak info, File file, String[] allowTypes) {  
        if (file.isDirectory()) {  
            long size = 0;  
            File[] allFiles = file.listFiles();  
            for (File f : allFiles) {  
