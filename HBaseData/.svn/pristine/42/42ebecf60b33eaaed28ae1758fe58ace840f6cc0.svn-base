...
Ext.hoo.tree.FileSystemTree.TREE_CREATE_DIR_URL = "http://localhost:8080/HBaseData/filebrowser/getdir?method=mkDir";  
Ext.hoo.tree.FileSystemTree.TREE_DATA_URL = "http://localhost:8080/HBaseData/filebrowser/getdir?method=getData";  